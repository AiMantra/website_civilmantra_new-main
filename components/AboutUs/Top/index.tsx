        ...
        <div className="relative w-full h-[80vh] overflow-hidden">
            ...
            <div className="flex items-center h-full z-10 px-4 max-w-[90vw] mx-auto">
                <motion.div
                    ...
                    className="max-w-[70vw] mt-12  p-4 rounded"
                >
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl text-secondary my-5 drop-shadow-md">
                        A Legacy Etched in <span className="text-red-600">Stone</span>
                    </h1>
                    <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white drop-shadow-md">
                    ...
                    <motion.p
                        ...
                        animate="visible"
                        transition={{ duration: 0.8, delay: 0.2 }}
                        className="mt-5 text-base max-sm:hidden sm:text-lg md:text-xl leading-relaxed text-white drop-shadow-md"
                    >
            ...
            <style jsx>{`
                ...
                .bg-slideshow {
                    ...
                    filter: brightness(1); /* Reduce brightness */
                }
            `}</style>
        </div>
    );
